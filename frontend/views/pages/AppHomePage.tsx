...
const homeTiles: HomeTile[] = [
  {
    ...
    badgeClassName: 'border-amber-200/12 bg-amber-100/8 text-amber-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-cyan-200/12 bg-cyan-100/8 text-cyan-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-rose-200/12 bg-rose-100/8 text-rose-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-violet-200/12 bg-violet-100/8 text-violet-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-orange-200/12 bg-orange-100/8 text-orange-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-indigo-200/12 bg-indigo-100/8 text-indigo-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-sky-200/12 bg-sky-100/8 text-sky-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-emerald-200/12 bg-emerald-100/8 text-emerald-50',
  ...
  },
  {
    ...
    badgeClassName: 'border-slate-200/12 bg-slate-100/8 text-slate-50',
            ...
            >
              ...
              <div className="relative flex h-full flex-col">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <span className={`rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.22em] ${tile.badgeClassName}`}>
                    {tile.badge}
                  </span>
                </div>
