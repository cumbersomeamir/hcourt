        ...
        <div className="mb-4 sm:mb-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
            <div>
              ...
              <p className="mt-1 text-xs sm:text-sm text-blue-600 dark:text-blue-300 font-medium">
                Source: {cityLabel}
              </p>
            </div>
            <button
        ...
        {result && (
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-4">
            ...
            {result.orderJudgments && result.orderJudgments.length > 0 && (
              <div className="mt-6">
                <h3 className="text-sm sm:text-base font-semibold text-gray-900 dark:text-gray-100 mb-2 sm:mb-3">
                ...
                <div className="space-y-2">
                  {result.orderJudgments.map((entry) => (
                    <div
                      ...
                      className="rounded-md border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 px-3 py-2 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2"
                    >
                      <div className="text-xs sm:text-sm text-gray-800 dark:text-gray-200">
                        <span className="font-medium">#{entry.srNo}</span> {entry.date || 'Date unavailable'}
                      </div>
                      <button
                        onClick={() => downloadJudgment(entry.viewUrl, entry.date, entry.judgmentId)}
                        disabled={judgmentLoadingId === entry.judgmentId}
                        className="rounded-md bg-indigo-600 px-3 py-2 text-xs sm:text-sm font-medium text-white hover:bg-indigo-700 active:bg-indigo-800 disabled:opacity-60 w-full sm:w-auto"
                      >
