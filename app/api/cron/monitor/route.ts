...
/**
 * Backend cron job endpoint for monitoring changes
 * This runs server-side, independent of browser state
 * 
 * Set up with Vercel Cron or external service (cron-job.org) to call every 30 seconds
 * Authorization: Use CRON_SECRET environment variable
 */
export async function GET(request: Request) {
  // Verify authorization (for cron services)
...
/**
 * POST endpoint for manual triggering or external services
 */
